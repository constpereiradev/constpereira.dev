<template>
    <!--<div class="container-fluid">
        ...
        <div class="row mb-3">
         ...
         Modal de registro de novo colaborador 
        <div class="row">
            <div class="modal fade" id="novoColaboradorModal" tabindex="-1" aria-labelledby="novoColaboradorModalLabel"
                aria-hidden="true">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <VueMultiselect v-model="novoColaborador.status" :placeholder="'Escolha uma opção'"
        ...
        <div class="row mb-3">
            <div class="card-body bg-white shadow-sm">
                <div class="row mb-3">
                    ...
                    <div class="col-sm-4">
                        <input v-model="this.formColaborador.setor" @keyup="pesquisarColaborador" placeholder="Setor"
                            class="form-control" type="text" name="" id="">
                    </div>
                    <div class="col-sm-3">
                                    ...
                                    <tr v-for="colaborador in colaboradores">
                                        ...
                                        <td>
                                            ...
                                            <button @click="limparCampos(colaborador)" data-bs-toggle="modal"
                                                ...
                                                class="btn btn-primary btn-icone">
                                                <h5><i class="bi bi-pencil-square justify-content-center d-flex"></i>
                                                </h5>
                                            </button>
                                        </td>
                                        <td>
                                            ...
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="row mb-3">
                                                            <div class="col-sm-6">
                                                                <label class="form-label fw-bold">Cargo</label>
                                                                <input class="form-control" type="text" name="" id=""
                                                                    v-model="this.colaborador.cargo">
                                                            </div>
                                                            <div class="col-sm-6">
                                                                <label class="form-label fw-bold">Setor</label>
                                                                <input class="form-control" type="text" name="" id=""
                                                                    v-model="this.colaborador.setor">
                                                            </div>
                                                        </div>
                                                        <div class="row mb-3">
                                                            <div class="col-sm-6">
                                                                <label class="form-label fw-bold">Salário</label>
                                                                <input class="form-control" type="text" name="" id=""
                                                                    v-model="this.colaborador.salario">
                                                            </div>
                                                            <div class="col-sm-6">
                                                                <label class="form-label fw-bold">Status</label>
                                                    ...
                                                    <div class="modal-footer">
                                                        <button type="button" class="btn btn-secondary"
                                                            data-bs-dismiss="modal">Cancelar</button>
                                                        <button @click="editarColaborador(colaborador.id)" type="button"
